const legalDraftTypes = [
  ...
  // Civil - IA (Interlocutory Applications)
  { id: "civil-amendment-pleadings", label: "Amendment Pleadings", category: "Civil", subcategory: "IA - Interlocutory Applications", type: "Litigation" },
  { id: "civil-stay-petition", label: "Stay Petition", category: "Civil", subcategory: "IA - Interlocutory Applications", type: "Litigation" },
  { id: "civil-temporary-injunction", label: "Temporary Injunction", category: "Civil", subcategory: "IA - Interlocutory Applications", type: "Litigation" },
  { id: "civil-delay-condonation", label: "Delay Condonation", category: "Civil", subcategory: "IA - Interlocutory Applications", type: "Litigation" },
  { id: "civil-restoration-petition", label: "Restoration Petition", category: "Civil", subcategory: "IA - Interlocutory Applications", type: "Litigation" },
  { id: "civil-implead-petition", label: "Implead Petition", category: "Civil", subcategory: "IA - Interlocutory Applications", type: "Litigation" },
  { id: "civil-receiver-petition", label: "Receiver Petition", category: "Civil", subcategory: "IA - Interlocutory Applications", type: "Litigation" },
  { id: "civil-commission-petition", label: "Commission Petition", category: "Civil", subcategory: "IA - Interlocutory Applications", type: "Litigation" },
  { id: "civil-set-aside-ex-parte", label: "Set Aside Ex Parte Petition", category: "Civil", subcategory: "IA - Interlocutory Applications", type: "Litigation" },
  // Civil - Affidavits
